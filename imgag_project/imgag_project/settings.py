"""
Django settings for imgag_project project.
...
ALLOWED_HOSTS = ["imgag.pythonanywhere.com", "localhost", ]
...
ROOT_URLCONF = 'imgag_project.urls'
...
WSGI_APPLICATION = 'imgag_project.wsgi.application'
